class Railway
  ...
  ACTIONS = [
    ...
    { number: 2, name: 'All stations', controller: StationsController, method: :all },
    ...
    { number: 8, name: 'Move train', controller: TrainsController, method: :move_train }, 
    { number: 9, name: 'List of trains', controller: TrainsController, method: :all }, 
